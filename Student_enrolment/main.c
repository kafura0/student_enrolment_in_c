...
//admission form that prompts for user enrollment data
void admission_form()
{
    //check all the existing student ids already enrolled so that student id is unique
    int check_id;
    ...
    //if suden id exists ..give error to enter different id
...
//display academic details of the student based on branch
void show_academic_details() {
    ...
    if ((student_id=fopen("student_id.txt","r+"))==NULL){
        ...
        // checking in student_id file for the id entered
        ...
        if(Found) {
            ...
            case 4: printf("\t\tDetails for the First Year\n\n\n");
                    ...
                    printf("\t8\t\Constitution of India\t\t\tNIL\n");
                    printf("\n\n\t\tTotal Credits = 23");
                    break;
            case 5:
            case 6:
